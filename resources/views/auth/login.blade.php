...
@section('title', __('Sign In') . ' - YeaBneh Store')
...
<section class="py-16 min-h-[70vh] flex items-center">
    <div class="max-w-[460px] mx-auto px-5 w-full">
        <div class="text-center mb-10">
            ...
            <h1 class="text-2xl lg:text-3xl font-extrabold uppercase tracking-[-0.02em] mb-2">{{ __('Welcome Back') }}</h1>
            <p class="text-gray-500 text-[14px]">{{ __('Sign in to your account') }}</p>
        </div>
        ...
        <div class="relative mb-8">
            ...
            <span class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-[12px] text-gray-400 font-medium uppercase tracking-wider">{{ __('or sign in with email') }}</span>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-[13px] text-gray-500">{{ __('Remember me') }}</span>
                    </label>
                </div>
            </div>
...
{{ __('Sign In') }}
        ...
        <p class="text-center mt-8 text-[13px] text-gray-500">
            ...
            <a href="{{ route('register') }}" class="text-brand font-semibold hover:underline">{{ __('Create one') }}</a>
        </p>
    </div>
</section>
