...
<section class="relative hero-gradient overflow-hidden">
    ...
    <div class="max-w-[1680px] mx-auto px-5 lg:px-10 relative">
        <div class="min-h-[80vh] flex items-center py-20">
            <div class="max-w-3xl">
                <p class="text-accent text-[11px] font-bold uppercase tracking-[0.3em] mb-6 fade-up">YeaBneh Equipment</p>
                <h1 class="text-5xl sm:text-6xl lg:text-[5.5rem] font-extrabold text-white leading-[0.95] tracking-[-0.03em] uppercase mb-8 fade-up">
                    New Look.<br>
                    <span class="text-accent">More power.</span><br>
                    More control.
                </h1>
                <p class="text-gray-400 text-lg font-light mb-10 max-w-lg fade-up-delay">All in your hands. Premium gear engineered for athletes who push limits.</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="{{ route('shop.index', ['category' => 'apparel']) }}" class="relative group overflow-hidden bg-brand aspect-[16/10]">
                ...
                <div class="absolute bottom-6 left-6 right-6">
                    <span class="inline-block bg-accent text-brand px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.15em] group-hover:bg-white transition-colors duration-300">Men's Collection</span>
                </div>
            </a>
            <a href="{{ route('shop.index', ['category' => 'apparel']) }}" class="relative group overflow-hidden bg-brand aspect-[16/10]">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                <div class="absolute bottom-6 left-6 right-6">
                    <span class="inline-block bg-accent text-brand px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.15em] group-hover:bg-white transition-colors duration-300">Women's Collection</span>
                </div>
            </a>
            <a href="{{ route('shop.index', ['category' => 'equipment']) }}" class="relative group overflow-hidden bg-brand aspect-[16/10] sm:col-span-2 lg:col-span-1">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                <div class="absolute bottom-6 left-6 right-6">
                    <span class="inline-block bg-accent text-brand px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.15em] group-hover:bg-white transition-colors duration-300">Elite Equipment</span>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="max-w-[1680px] mx-auto px-5 lg:px-10">
        <div class="flex items-end justify-between mb-10">
            <div>
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold uppercase tracking-[-0.02em]">Elite Equipment for Ultimate Performance</h2>
            </div>
        ...
        <div class="mt-10 text-center lg:hidden">
            <a href="{{ route('shop.index', ['category' => 'equipment']) }}" class="btn-outline inline-block px-8 py-3.5 text-[11px] font-bold uppercase tracking-[0.15em]">Shop All Equipment</a>
        </div>
    </div>
</section>
@endif
...
<section class="py-20 bg-surface">
    <div class="max-w-[1680px] mx-auto px-5 lg:px-10 text-center">
        ...
        <h2 class="text-3xl sm:text-4xl font-extrabold uppercase tracking-[-0.02em] mb-4">Join Our Community</h2>
        <p class="text-gray-500 max-w-md mx-auto mb-10 text-[15px]">Millions of athletes training smarter with YeaBneh. Download the app and start your journey.</p>
...
<section class="py-20">
    <div class="max-w-[1680px] mx-auto px-5 lg:px-10">
        <div class="bg-gradient-to-r from-red-600 to-red-500 p-8 lg:p-14 mb-10 relative overflow-hidden">
            ...
            <p class="text-[11px] font-bold uppercase tracking-[0.25em] text-red-200/70 mb-2">Over 50% Off</p>
            <h2 class="text-3xl sm:text-4xl font-extrabold uppercase text-white tracking-[-0.02em]">Shop Clearance</h2>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-5">
        ...
        <div class="mt-10 text-center">
            <a href="{{ route('shop.index', ['clearance' => 1]) }}" class="btn-outline inline-block px-8 py-3.5 text-[11px] font-bold uppercase tracking-[0.15em]">View All Clearance</a>
        </div>
    </div>
</section>
@endif
...
<section class="py-20 bg-surface">
    <div class="max-w-[1680px] mx-auto px-5 lg:px-10">
        <div class="flex items-end justify-between mb-10">
            <div>
                <p class="text-[11px] font-bold uppercase tracking-[0.25em] text-gray-400 mb-3">Just Dropped</p>
                <h2 class="text-3xl sm:text-4xl font-extrabold uppercase tracking-[-0.02em]">New Arrivals</h2>
            </div>
