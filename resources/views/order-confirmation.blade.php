...
@section('title', 'Order Confirmed - YeaBneh Store')
...
<section class="py-16">
    <div class="max-w-xl mx-auto px-5 text-center">
        ...
        <h1 class="text-3xl font-extrabold uppercase tracking-[-0.02em] mb-4">Order Confirmed!</h1>
        <p class="text-gray-500 mb-2 text-[15px]">Thank you for your order.</p>
        <p class="text-[13px] text-gray-400 mb-10">Order Number: <span class="font-bold text-brand">{{ $order->order_number }}</span></p>
        ...
        <div class="bg-surface-muted p-7 text-left mb-8">
            <h3 class="text-[11px] font-bold uppercase tracking-[0.15em] text-gray-500 mb-4">Items</h3>
