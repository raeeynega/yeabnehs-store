...
<section class="py-16">
    <div class="max-w-[1680px] mx-auto px-5 lg:px-10">
        <div class="mb-10">
            <h1 class="text-4xl lg:text-5xl font-extrabold uppercase tracking-[-0.02em]">Shop All</h1>
            <p class="text-gray-400 mt-2 text-[14px]">{{ $products->total() }} products</p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <aside class="lg:w-60 shrink-0">
                <form method="GET" action="{{ route('shop.index') }}" id="filterForm">
                    ...
                    <div class="mb-8">
                        <h3 class="text-[11px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-4">Category</h3>
                        <div class="space-y-2.5">
                            <label class="flex items-center gap-2.5 text-[13px] cursor-pointer group">
                                ...
                                <span class="group-hover:opacity-60 transition">All</span>
                            </label>
                    ...
                    <div class="mb-8">
                        <h3 class="text-[11px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-4">Sort By</h3>
            ...
            <div class="flex-1">
                ...
                @else
                    <div class="text-center py-24">
                        <p class="text-lg text-gray-400 mb-4">No products found.</p>
                        <a href="{{ route('shop.index') }}" class="btn-primary inline-block px-8 py-3 text-[12px] font-bold uppercase tracking-[0.15em]">Clear Filters</a>
                    </div>
                @endif
            </div>
        </div>
